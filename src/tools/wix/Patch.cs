...
namespace WixToolset.Data
{
    ...
    public class Patch
    {
        ...
        public void AttachTransforms(List<PatchTransform> transforms)
        {
            ...
            ITable wixPatchIdTable = this.patch.Tables["WixPatchId"];
            ...
            ITable patchMediaTable = patch.Tables["Media"];
            ...
            ITable patchBaselineTable = patch.Tables["WixPatchBaseline"];
            ...
            ITable patchSummaryInfo = patch.EnsureTable(this.tableDefinitions["_SummaryInformation"]);
            ...
            ITable msiPatchMetadataTable = patch.Tables["MsiPatchMetadata"];
            ...
            ITable wixPatchMetadataTable = patch.Tables["WixPatchMetadata"];
            ...
            foreach (PatchTransform mainTransform in transforms)
            {
                ...
                ITable patchRefTable = patch.Tables["WixPatchRef"];
                ...
                ITable transformMediaTable = mainTransform.Transform.Tables["Media"];
            ...
            ITable wixPatchTargetTable = patch.Tables["WixPatchTarget"];
        ...
        private bool CheckUninstallableTransform(string productCode, Output transform, ArrayList tables)
        {
            ...
            {
                ITable wixTable = transform.Tables[table];
                if (null != wixTable)
                {
        ...
        public static bool ReduceTransform(Output transform, ITable patchRefTable)
        {
            ...
            foreach (Row patchRefRow in patchRefTable.Rows)
            {
                ...
                ITable table = transform.Tables[tableName];
                if (table == null)
                {
                    // table not found
                    continue;
            ...
            int keptRows = 0;
            ITable directoryTable = null;
            ITable featureTable = null;
            ITable lockPermissionsTable = null;
            ITable msiLockPermissionsTable = null;

            foreach (ITable table in transform.Tables)
            {
        ...
        {
            ITable propertyTable = transform.Tables["Property"];
        ...
        private static int ReduceTransformSequenceTable(ArrayList sequenceList, Hashtable oldSections, Hashtable newSections, Hashtable customAction)
        {
            ...
            foreach (ITable currentTable in sequenceList)
            {
        ...
        public Output BuildPairedTransform(string patchId, string clientPatchId, Output mainTransform, MediaRow mediaRow, int validationFlags, out string productCode)
        {
            ...
            ITable mainPropertyTable = mainTransform.Tables["Property"];
            ...
            ITable mainSummaryTable = mainTransform.Tables["_SummaryInformation"];
            ...
            ITable pairedSummaryTable = pairedTransform.EnsureTable(this.tableDefinitions["_SummaryInformation"]);
            foreach (Row mainSummaryRow in mainSummaryTable.Rows)
            {
            ...
            if (null != mainFileTable && 0 < mainFileTable.Rows.Count)
            {
                ...
                ITable pairedFileTable = pairedTransform.EnsureTable(mainFileTable.Definition);
            ...
            ITable pairedMediaTable = pairedTransform.EnsureTable(this.tableDefinitions["Media"]);
            ...
            ITable pairedPackageTable = pairedTransform.EnsureTable(this.tableDefinitions["PatchPackage"]);
            ...
            int allowRemoval = 0;
            ITable msiPatchMetadataTable = this.patch.Tables["MsiPatchMetadata"];
            if (null != msiPatchMetadataTable)
            {
            ...
            ITable pairedPropertyTable = pairedTransform.EnsureTable(this.tableDefinitions["Property"]);
            ...
            ITable _summaryInformationTable = this.patch.Tables["_SummaryInformation"];
