//-------------------------------------------------------------------------------------------------
// <copyright file="MsiPropertyRow.cs" company="Outercurve Foundation">
...
namespace WixToolset.Data.Rows
{
    ...
    /// </summary>
    public sealed class MsiPropertyRow : Row
    {
        /// <summary>
        ...
        public MsiPropertyRow(SourceLineNumber sourceLineNumbers, Table table) :
