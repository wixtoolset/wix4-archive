//-------------------------------------------------------------------------------------------------
// <copyright file="MatchValuesTest.cpp" company="Outercurve Foundation">
...
//
// <summary>
//    Test "matching" values, where values across two sources are equivalent but not identical
//    due to different modified time, or source. "Matching" functionality is designed to synchronize
//    these equivalent values in a way that future changes to the value by one source or the other
//    do not result in sync conflicts.
// </summary>
//-------------------------------------------------------------------------------------------------
